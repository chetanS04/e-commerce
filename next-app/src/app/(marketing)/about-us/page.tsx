            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-orange-50/50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Why Choose Zelton?</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-0">
                            <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                                ...
                                <p className="text-gray-700 mb-5 text-lg leading-relaxed">
                                    Zelton was founded with a simple yet powerful vision: to create an online shopping destination that
