...
/**
 * @property string $status Possible values: pending, confirmed, processing, shipped, delivered, completed, cancelled
 */
class Order extends Model
{
    ...
    /**
     * Generate a unique delivery confirmation token
     */
    ...
    /**
     * Check if order can be confirmed for delivery
     */
    ...
    /**
     * Confirm delivery and mark order as completed
     */
